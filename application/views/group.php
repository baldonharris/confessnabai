	...
	<div class="row">
		<div class="col-md-3">
			<div class="list-group">
				<a href="#" class="list-group-item list-group-item-info" id="category"><strong>Group: </strong><?php echo $group_name; ?></a>
			</div>
			<div class="list-group">
		...
		<div class="col-md-9">
			...
			<div id="isolate_me">
				...
				<?php
					//$current_url = substr(base64_encode(current_url()),0,-2);
					$current_url = substr(base64_encode($this->uri->uri_string()),0,-2);
					//echo $current_url;
							...
							if(!$confessions['with_picture'][$x])
							{
								...
								<div class="panel panel-default">
									...
									<div class="panel-footer">
										...
										if(!strcmp($group_admin, $this->session->userdata('username')) || $this->session->userdata('account_type') == 3)
